 ...
 */
 function displayCanteenPlanningByMonthForm($DbConnection, $ProcessFormPage, $Month, $Year, $GradeGroup = '', $AccessRules = array(), $ViewsRestrictions = array())
 {
 ...
 *                                                    allowed to view some canteen registratrions
 */
 function displayCanteenPlanningByWeeksForm($DbConnection, $ProcessFormPage, $Week, $Year, $GradeGroup = '', $AccessRules = array(), $ViewsRestrictions = array())
 {
     // Compute start date and end date of the month
 ...
 *     - 2019-09-17 : v3.6. Display a waiting message when the page is loading
 *     - 2021-01-04 : v3.7. Remove {} and use substr() to extract 1 character from a string (for PHP 7.4)
 *     - 2022-07-13 : v3.8. Add filter by grade groups
 *
 * @since 2012-01-28
 *
 * @param $DbConnection         DB object             Object of the opened database connection
 ...
 *                                                    allowed to view some canteen registratrions
 */
 function displayCanteenPlanningForm($DbConnection, $ProcessFormPage, $StartDate, $EndDate, $SelectedDate, $ViewType = PLANNING_MONTH_VIEW, $GradeGroup = '', $AccessRules = array(), $ViewsRestrictions = array())
 {
             ...
             switch($RestrictionAccess)
             {
                 ...
                 default:
                     ...
                     $ArrayChildren = getChildrenListForCanteenPlanning($DbConnection, $StartDate, $EndDate, "ChildClass, FamilyLastname",
                                                                        FALSE, FALSE, PLANNING_BETWEEN_DATES, $ArrayParamsChildrenFilters);
