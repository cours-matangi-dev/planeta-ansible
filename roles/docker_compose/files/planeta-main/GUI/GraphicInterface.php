 ...
 */
 ...
 require 'GiHighLevelsInstallFormsLibrary.php';               // Primitives library used to display forms to install the application 
 ...
 require 'GiHighLevelsFormsMeetingRoomsLibrary.php';          // Primitives library used to display forms to manage meeting rooms and registrations
 require 'GiHighLevelsFormsLogEventsLibrary.php';             // Primitives library used to display forms to manage log events
 require 'GiHighLevelsFormsForumLibrary.php';                 // Primitives library used to display forms to manage forums
 ...
 * @author Christophe Javouhey
 * @version 1.4
 *     - 2016-03-04 : v1.2. Change keywords in meta
 *     - 2016-06-03 : v1.3. A same CSS of a plugin is included only one time, taken into account $CONF_CHARSET
 *     - 2022-06-20 : v1.4. Change keywords in meta and remove favicon
 *
 * @since 2012-01-12
 *
 ...
 */
 function initGraphicInterface($Title, $TabStylesheets, $TabJavascripts, $Style = '', $OnLoadFct = '')
 {
     ...
     echo "\t<meta name=\"keywords\" content=\"Planeta Calandreta, intranet, Muret\" />\n";
