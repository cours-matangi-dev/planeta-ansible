 ...
 * @version 1.1
 *     - 2021-10-11 : v1.1. Patch the bug about charset problem of the bill
 *
 * @since 2007-01-25
 *
 * @param $XmlData              String               XML stream (data or path filename)
         ...
         switch($TransformType)
         {
             case XMLFILE_XSLFILE:
                 ...
                 if ((strToUpper($GLOBALS['CONF_CHARSET']) != 'UTF-8')
                     && (mb_detect_encoding($XmlParser->getElementsByTagName('familylastname')->item(0)->nodeValue) == 'UTF-8'))
                 {
                     $XmlParser->getElementsByTagName('familylastname')->item(0)->nodeValue = utf8_decode($XmlParser->getElementsByTagName('familylastname')->item(0)->nodeValue);
                 }
 ...
 *                    of the bill
 *     - 2020-03-09 : v1.7. Taken into account BillNbCanteenRegistrations and BillNbNurseryRegistrations fields
 *     - 2022-06-07 : v1.8. Taken into account BillOtherAmount field
 *
 * @since 2012-02-23
 *
