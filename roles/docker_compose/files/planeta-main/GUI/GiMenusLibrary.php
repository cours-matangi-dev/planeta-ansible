 ...
 * @author STNA/7SQ
 * @version 2.1
 *     - 2005-02-11 : v1.1. Can display separators between items
 *     - 2007-01-11 : v2.0. New interface and take into account the visibility of the items
 *     - 2011-08-10 : v2.1. Allow an ID for the <UL> of the contextual menu
 *
 * @since 2003-12-20
 *
 ...
 *     - 2021-02-10 : v3.4. Taken into account "log access" item
 *     - 2021-04-11 : v4.0. Taken into account the items of the "Forum" module and the "forum categories list"
 *                          in the "admin" menu
 *
 * @since 2012-01-12
 *
 ...
 */
 function displaySupportMemberContextualMenu($MenuName, $Depth, $NumItemSelected)
 {
     ...
     switch(strtolower($MenuName))
     {
        ...
        case 'forum':
               displayContextualMenu(
                                     $GLOBALS['LANG_MAIN_MENU_SUPPORT_FORUM_MANAGEMENT'],
                                     array(
                                           $GLOBALS["LANG_CONTEXTUAL_MENU_SUPPORT_FORUM_FORUMS_LIST"]
                                          ),
                                     array(
                                           $RootLink."Forum/ForumsList.php"
                                          ),
                                     array(
                                           $GLOBALS["LANG_CONTEXTUAL_MENU_SUPPORT_FORUM_FORUMS_LIST_TIP"]
                                          ),
                                     $NumItemSelected,
                                     'forum_contextualmenu',
                                     array(),
                                     array_values($GLOBALS['ACCESS_CONTEXTUALMENUS'][$_SESSION["SupportMemberStateID"]]['forum'])
                                    );
               break;
        ...
        case 'admin':
               displayContextualMenu(
                                     ...
                                     array(
                                           ...
                                           $GLOBALS["LANG_CONTEXTUAL_MENU_SUPPORT_ADMIN_FORUM_CATEGORIES_LIST"],
                                           $GLOBALS['LANG_CONTEXTUAL_MENU_SUPPORT_ADMIN_CONFIG_PARAMETERS_LIST'],
                                           $GLOBALS['LANG_CONTEXTUAL_MENU_SUPPORT_ADMIN_LOGS_ACCESS'],
                                           $GLOBALS['LANG_CONTEXTUAL_MENU_SUPPORT_ADMIN_GDPR']
                                          ),
                                     array(
                                           ...
                                           $RootLink."Admin/ForumCategoriesList.php",
                                           $RootLink."Admin/ConfigParametersList.php",
                                           $RootLink."Admin/LogsAccess.php",
                                           $RootLink."Admin/GDPRManagement.php"
                                          ),
                                     array(
                                           ...
                                           $GLOBALS["LANG_CONTEXTUAL_MENU_SUPPORT_ADMIN_FORUM_CATEGORIES_LIST_TIP"],
                                           $GLOBALS['LANG_CONTEXTUAL_MENU_SUPPORT_ADMIN_CONFIG_PARAMETERS_LIST_TIP'],
                                           $GLOBALS['LANG_CONTEXTUAL_MENU_SUPPORT_ADMIN_LOGS_ACCESS_TIP'],
                                           $GLOBALS['LANG_CONTEXTUAL_MENU_SUPPORT_ADMIN_GDPR_TIP']
                                          ),
                                     $NumItemSelected,
 ...
 * @author Christophe Javouhey
 * @version 4.0
 *     - 2013-04-03 : v2.0. Taken into account the "Cooperation" item
 *     - 2016-10-21 : v3.0. Taken into account the "Admin" item
 *     - 2021-04-09 : v4.0. Taken into account the "Forum" item
 *
 * @since 2012-01-12
 *
 * @param $Depth                Integer          Depth of the web page in the tree of the intranet
 */
 function displaySupportMainMenu($Depth = 0)
 {
     ...
     $ArrayMainMenuTips = array(
                                ...
                                $GLOBALS["LANG_MAIN_MENU_SUPPORT_FORUM_MANAGEMENT_TIP"]
                               );
