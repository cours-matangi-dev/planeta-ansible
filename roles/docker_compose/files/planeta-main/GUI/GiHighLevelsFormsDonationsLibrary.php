 ...
 * @author Christophe Javouhey
 * @version 1.3
 *     - 2018-05-16 : v1.1. Taken into account $CONF_DEFAULT_VALUES_SET to set default values
 *     - 2019-11-08 : v1.2. Calendar has a unique callback function (calendarCallback) and has input field
 *                    and $CONF_LANG in parameter
 *     - 2021-09-10 : v1.3. Patch a bug about "if ($DonationID == 0)" for PHP8
 *
 * @since 2016-05-31
 *
