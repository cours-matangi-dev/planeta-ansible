...
/**
 * Display the form to submit a new meeting room registration or update a meeting room registration,
 * in the current row of the table of the web page, in the graphic interface in XHTML
 *
 * @author Christophe Javouhey
 * @version 1.1
 *     - 2021-09-10 : v1.1. Patch a bug about "if ($MeetingRoomRegistrationID == 0)" for PHP8
 *
 * @since 2019-11-22
 *
 * @param $DbConnection                 DB object             Object of the opened database connection
 * @param $MeetingRoomRegistrationID    String                ID of the meeting room registration to display
