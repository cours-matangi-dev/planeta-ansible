 ...
 * @author STNA/7SQ
 * @version 2.3
 *     - 2004-04-16 : v2.0. Taken into account JavaScript code
 *     - 2007-03-28 : v2.1. Use the generateInputField() function
 *     - 2009-03-25 : v2.2. Allow to add a style
 *     - 2021-01-25 : v2.3. Taken inot account Placeholder parameter
 *
 * @since 2003-12-26
 *
 ...
 */
 function insertInputField($Name, $Type, $Maxlength, $Size, $Title, $Value, $Readonly = FALSE, $Checked = FALSE, $JavaScript = '', $Style = '', $Placeholder = '')
 {
     echo generateInputField($Name, $Type, $Maxlength, $Size, $Title, $Value, $Readonly, $Checked, $JavaScript, $Style, $Placeholder);
 }
 ...
 * @author STNA/7SQ, Christophe Javouhey
 * @version 2.3
 *     - 2004-04-16 : v2.1. Taken into account JavaScript code
 *     - 2009-03-25 : v2.2. Allow to add a style
 *     - 2021-01-25 : v2.3. Taken inot account Placeholder parameter
 *
 * @since 2004-03-17
 ...
 */
 function generateInputField($Name, $Type, $Maxlength, $Size, $Title, $Value, $Readonly = FALSE, $Checked = FALSE, $JavaScript = '', $Style = '', $Placeholder = '')
 {
     $tmp = '';
     if ($Name != '')
     {
 ...
 * in the graphic interface in XHTML
 *
 * @author STNA/7SQn Christophe Javouhey
 * @version 1.3
 *     - 2010-10-20 : allow to use different styles for the items ($TabStyles)
 *     - 2010-12-08 : allow to use a style for the select field ($Style)
 *     - 2021-09-10 : check if $ArrayData value is an array before count() for PHP8
 *
 * @since 2007-03-28
 *
 * @param $Name                 String              Name of the select field
