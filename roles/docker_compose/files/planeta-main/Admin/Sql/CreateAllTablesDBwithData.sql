...
--
-- Hôte : localhost
-- Généré le :  Lun 13 Juin 2022 à 11:37
...
--
-- Structure de la table `ForumCategoriesAccess`
--

DROP TABLE IF EXISTS `ForumCategoriesAccess`;
...
--
-- Structure de la table `ForumMessages`
--
...
--
-- Structure de la table `ForumTopicsLastReads`
--

DROP TABLE IF EXISTS `ForumTopicsLastReads`;
...
--
-- Structure de la table `ForumTopicsSubscribtions`
--

DROP TABLE IF EXISTS `ForumTopicsSubscribtions`;
...
INSERT INTO `SupportMembers` VALUES (1, 'Admin', 'Admin', NULL, 'admin@test.fr', '21232f297a57a5a743894a0e4a801fc3', '21232f297a57a5a743894a0e4a801fc3', 1, NULL, 'e00cf25ad42683b3df678c61f42c6bda', 1, NULL);
...
(9, 'Regent', 'Regent de la Calandreta.'),
(10, 'Resp CLAE', 'Responsable du CLAE.'),
(11, 'Famille Ext', 'Famille externe à la Calandreta utilisant l\'ALSH.');
...
--
-- Index pour la table `ForumCategoriesAccess`
--
ALTER TABLE `ForumCategoriesAccess` 
  ADD KEY `SupportMemberStateID` (`SupportMemberStateID`), 
  ADD KEY `ForumCategoryID` (`ForumCategoryID`);

--
-- Index pour la table `ForumMessages`
--
ALTER TABLE `ForumMessages` 
  ADD KEY `ForumTopicID` (`ForumTopicID`), 
  ADD KEY `SupportMemberID` (`SupportMemberID`);

--
-- Index pour la table `ForumTopics`
--
...
--
-- Index pour la table `ForumTopicsLastReads`
--
ALTER TABLE `ForumTopicsLastReads` 
  ADD KEY `ForumTopicID` (`ForumTopicID`), 
  ADD KEY `SupportMemberID` (`SupportMemberID`);

--
-- Index pour la table `ForumTopicsSubscribtions`
--
ALTER TABLE `ForumTopicsSubscribtions` 
  ADD KEY `ForumTopicID` (`ForumTopicID`), 
  ADD KEY `SupportMemberID` (`SupportMemberID`);
