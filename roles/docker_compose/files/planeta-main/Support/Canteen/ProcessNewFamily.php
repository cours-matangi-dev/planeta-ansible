 ...
 *     - 2020-09-24 : v3.6. Patch a bug about $AnnualContributionBalance when $CONF_CONTRIBUTIONS_ANNUAL_AMOUNTS
 *                    isn't set for a given school year
 ...
 */
 ...
 if (!empty($_POST["bSubmit"]))
 {
     if (isSet($_SESSION["SupportMemberID"]))
     {
         ...
         $MonthlyNurseryMode = strip_tags($_POST["lMonthlyNurseryMode"]);
         ...
         if ($ContinueProcess)
         {
             ...
             $FamilyID = dbAddFamily($DbCon, $CurrentDate, $Lastname, $TownID, $MainEmail, $SecondEmail, $NbNumbers, $NbPoweredNumbers,
                                     $Balance, $Comment, $DesactivationDate, $SpecialAnnualContribution, $MonthyContributionMode, $MonthlyNurseryMode,
                                     $AnnualContributionBalance);
