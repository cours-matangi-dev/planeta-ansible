...
/**
 * Support module : allow a supporter to update a bill. The supporter must be logged
 * to update the bill.
 *
 ...
 */
 ...
 if (md5($Id) == $CryptedID)
 {
      displayDetailsBillForm($DbCon, $Id, "ProcessUpdateBill.php", $CONF_ACCESS_APPL_PAGES[FCT_BILL], 'edit');
 }
 else
 {
