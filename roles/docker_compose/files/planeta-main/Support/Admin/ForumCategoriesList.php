...
/**
 * Support module : list forum categories
 *
 ...
 */
 ...
 displayStyledLinkText($LANG_GO_TO_CONTENT, '#ForumCategoriesList', 'Accessibility');
 ...
 if (isSet($_SESSION["SupportMemberID"]))
 {
     ...
     displaySupportMemberContextualMenu("admin", 1, Admin_ForumCategoriesList);
 ...
 displayTitlePage($LANG_SUPPORT_ADMIN_FORUM_CATEGORIES_LIST_PAGE_TITLE, 2);

 openParagraph();
 echo $LANG_SUPPORT_ADMIN_FORUM_CATEGORIES_LIST_PAGE_INTRODUCTION;
 closeParagraph();

 // Display a button to add a new forum category
 openParagraph();
 echo generateStyledPictureHyperlink($GLOBALS["CONF_ADD_ICON"], "../Admin/AddForumCategory.php?Cr=".md5('')."&amp;Id=",
                                    "$LANG_SUPPORT_ADMIN_FORUM_CATEGORIES_LIST_PAGE_ADD_CATEGORY.", 'Affectation', '_blank')
      ." $LANG_SUPPORT_ADMIN_FORUM_CATEGORIES_LIST_PAGE_ADD_CATEGORY.";
 closeParagraph();

 displaySearchForumCategoriesForm($DbCon, $TabParams, "ForumCategoriesList.php", $Page, "SortFct", $OrderBy,
                                  "UpdateForumCategory.php", $CONF_ACCESS_APPL_PAGES[FCT_ADMIN]);
