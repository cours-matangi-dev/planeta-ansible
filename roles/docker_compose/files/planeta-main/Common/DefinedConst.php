 ...
 */
 ...
 define('FCT_FORUM', 20);
 define('FCT_FORUM_TOPIC', 21);
 define('FCT_FORUM_MESSAGE', 22);
 ...
 define("EVT_SERV_BILL", "bill");              // Bill
 ...
 define("EVT_SERV_FORUM_TOPIC", "forum_topic");     // Only for forum
 define("EVT_SERV_FORUM_MESSAGE", "forum_message");     // Only for forum
 define("EVT_SERV_FORUM_TOPIC_SUBSCRIBTION", "forum_topic_subscribtion");  // Only for forum
 ...
 define("OBJ_FORUM_MESSAGE", 22);   // Forum message object
 ...
 define("STAT_TYPE_NB_CANTEEN_REGISTRATIONS", "NB_CANTEEN_REGISTRATIONS");  // Stat about the nb canteen registrations
 define("STAT_TYPE_NB_DOC_APPROVALS", "NB_DOC_APPROVALS_BY_FAMILIES");  // Stat about the nb of approvals of documents by families
 define("STAT_TYPE_NB_EVENT_REGISTRATIONS", "NB_EVENT_REGISTRATIONS");  // Stat about the nb event registrations
 define("STAT_TYPE_NB_MORE_MEALS", "NB_MORE_MEALS");  // Stat about the nb more meals registrations
 define("STAT_TYPE_NB_NURSERY_REGISTRATIONS", "NB_NURSERY_REGISTRATIONS");  // Stat about the nb canteen registrations
 ...
 // Constants of the FORUM main menu
 define('Forum_ForumsList', 1);
 ...
 define('Admin_ForumCategoriesList', 9);
 define('Admin_ConfigParametersList', 10);
 define('Admin_LogsAccess', 11);
 define('Admin_GDPR', 12);
 ...
 //##################### DbForumLibrary.php constants #################
 define("FORUM_ACCESS_CREATE_TOPIC", 'c');
 define("FORUM_ACCESS_WRITE_MSG", 'w');
 define("FORUM_ACCESS_READ_MSG", 'r');
 define("FORUM_ACCESS_NO_ACCESS", 'n');

 define("FORUM_TOPIC_OPENED", 0);
 define("FORUM_TOPIC_AUTHOR_ONLY", 1);
 define("FORUM_TOPIC_CLOSED", 9);
 ...
 //################### Support member state options constants #########
 define("SMS_OPT_SEND_MESSAGE_AUTHOR", 0);  // To replace author lastname of the message by support member state name
?>