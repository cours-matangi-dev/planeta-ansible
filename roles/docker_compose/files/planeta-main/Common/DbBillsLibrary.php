 ...
 *                          fields
 *     - 2022-06-07 : v1.5. Taken into account BillOtherAmount field
 *
 * @since 2012-02-23
 *
 * @param $DbConnection                      DB object    Object of the opened database connection
 ...
 * @param $BillOtherAmount                   Float        Amount of other fee (>= 0 or <= 0)
 *
 * @return Integer                           The primary key of the bill [1..n], 0 otherwise
 */
 function dbAddBill($DbConnection, $BillDate, $BillForDate, $FamilyID, $BillPreviousBalance = 0, $BillDeposit = 0, $BillMonthlyContribution = 0, $BillCanteenAmount = 0, $BillWithoutMealAmount = 0, $BillNurseryAmount = 0, $BillPaidAmount = 0.00, $BillNurseryNbDelays = 0, $BillNbCanteenRegistrations = NULL, $BillNbNurseryRegistrations = NULL, $BillOtherAmount = 0.00)
 {
             ...
             if ($DbResult->numRows() == 0)
             {
                 ...
                 if ($id != 0)
                 {
                     $DbResult = $DbConnection->query("INSERT INTO Bills SET BillID = $id, FamilyID = $FamilyID,
                                                      ...
                                                      BillOtherAmount = $BillOtherAmount $BillDate $BillForDate $BillNbCanteenRegistrations
 ...
 */
 function dbUpdateBill($DbConnection, $BillID, $BillDate, $BillForDate, $FamilyID, $BillPreviousBalance = NULL, $BillDeposit = NULL, $BillMonthlyContribution = NULL, $BillCanteenAmount = NULL, $BillWithoutMealAmount = NULL, $BillNurseryAmount = NULL, $BillPaidAmount = NULL, $BillNurseryNbDelays = NULL, $BillNbCanteenRegistrations = NULL, $BillNbNurseryRegistrations = NULL, $BillOtherAmount = NULL)
 {
     ...
     if (!is_Null($BillOtherAmount))
     {
         // The BillOtherAmount field will be updated
         $ArrayParamsUpdate[] = "BillOtherAmount = $BillOtherAmount";
     }
 ...
 *     - 2020-03-09 : v1.6. Taken into account BillNbCanteenRegistrations and BillNbNurseryRegistrations fields
 *     - 2022-06-07 : v1.7. Taken into account BillOtherAmount field
 *
 * @since 2012-02-23
 *
 * @param $DbConnection         DB object            Object of the opened database connection
 ...
 */
 function getBills($DbConnection, $StartDate, $EndDate = NULL, $OrderBy = 'BillForDate', $Mode = PLANNING_BETWEEN_DATES, $ArrayParams = array(), $LimitRecords = 0)
 {
     ...
     $Select = "SELECT b.BillID, b.BillDate, b.BillForDate, b.BillPreviousBalance, b.BillDeposit, b.BillMonthlyContribution,
               ...
               b.BillNurseryNbDelays, b.BillOtherAmount, b.BillPaidAmount, b.BillPaid,
         ...
         if ($DbResult->numRows() > 0)
         {
             ...
             while($Record = $DbResult->fetchRow(DB_FETCHMODE_ASSOC))
             {
                 ...
                 $fAmount = $Record['BillMonthlyContribution'] + $Record['BillCanteenAmount'] + $Record['BillWithoutMealAmount']
                            + $Record['BillNurseryAmount'] - $Record['BillDeposit'] + $Record['BillOtherAmount'];
 ...
 * @author Christophe Javouhey
 * @version 1.2
 *     - 2013-01-31 : v1.1. Taken into account the new parameter "AmountMode"
 *     - 2022-06-07 : v1.2. Taken into account BillOtherAmount field
 *
 * @since 2012-03-09
 *
 * @param $DbConnection        DB object    Object of the opened database connection
