...
/**
 * Common module : library of database functions used for the Families and HistoFamilies tables
 *
 ...
 * @author Christophe Javouhey
 * @version 1.6
 *     - 2012-07-12 : v1.1. Taken into account the FamilySpecialAnnualContribution field and FamilyNbMembers can be = 0
 *     - 2013-10-09 : v1.2. Taken into account the FamilyMonthlyContributionMode field and the HistoFamilies table
 *     - 2014-08-06 : v1.3. Patch a bug about $FamilyID not declared ($id instead)
 *     - 2019-07-16 : v1.4. Taken into account the FamilyAnnualContributionBalance field
 *     - 2021-05-18 : v1.5. Taken into account FamilyMainPicture and FamilySecondPicture fields and patch the bug
 *                    about $FamilyComment not in the "INSERT" SQL query
 *     - 2022-06-06 : v1.6. Taken into account FamilyMonthlyNurseryMode field
 *
 * @since 2012-01-17
 *
 * @param $DbConnection                       DB object    Object of the opened database connection
 ...
 *                                                         1 => benefactor mode of monthy contribution
 *                                                         2 => ... [0..n]
 * @param $FamilyMonthlyNurseryMode           Integer      0 => default mode to pay nursery registrations
 *                                                         1 => other mode to pay
 *                                                         2 => ... [0..n]
 * @param $FamilyAnnualContributionBalance    Float        Balance about annual contributions of the family
 * @param $FamilyMainPicture                  String       Picture (path) of the main e-mail address
 * @param $FamilySecondPicture                String       Picture (path) of the second e-mail address
 *
 * @return Integer                            The primary key of the family [1..n], 0 otherwise
 */
 function dbAddFamily($DbConnection, $FamilyDate, $FamilyLastname, $TownID, $FamilyMainEmail, $FamilySecondEmail = '', $FamilyNbMembers = 1, $FamilyNbPoweredMembers = 0, $FamilyBalance = 0.00, $FamilyComment = '', $FamilyDesactivationDate = NULL, $FamilySpecialAnnualContribution = 0, $FamilyMonthlyContributionMode = 0, $FamilyMonthlyNurseryMode = 0, $FamilyAnnualContributionBalance = 0.00, $FamilyMainPicture = '', $FamilySecondPicture = '')
 {
         ...
         && ($FamilyMonthlyNurseryMode >= 0))
     {
         ...
         if (!DB::isError($DbResult))
         {
             if ($DbResult->numRows() == 0)
             {
                 ...
                 if (empty($FamilyMainPicture))
                 {
                     $FamilyMainPicture = "";
                 }
                 else
                 {
                     $FamilyMainPicture = ", FamilyMainPicture = \"$FamilyMainPicture\"";
                 }

                 if (empty($FamilySecondPicture))
                 {
                     $FamilySecondPicture = "";
                 }
                 else
                 {
                     $FamilySecondPicture = ", FamilySecondPicture = \"$FamilySecondPicture\"";
                 }
                 ...
                 if ($id != 0)
                 {
                     $DbResult = $DbConnection->query("INSERT INTO Families SET FamilyID = $id, FamilyLastname = \"$FamilyLastname\",
                                                      ...
                                                      FamilyMonthlyNurseryMode = $FamilyMonthlyNurseryMode,
                                                      FamilyAnnualContributionBalance = $FamilyAnnualContributionBalance, FamilyBalance = $FamilyBalance
                                                      $FamilySecondEmail $FamilyDate $FamilyDesactivationDate $FamilyComment $FamilyMainPicture
                                                      $FamilySecondPicture");
                     if (!DB::isError($DbResult))
                     {
                         ...
                         $idHisto = dbAddHistoFamily($DbConnection, date("Y-m-d H:i:s"), $id, $TownID, $FamilyBalance,
                                                     $FamilyMonthlyContributionMode, $FamilyMonthlyNurseryMode);
 ...
 * @version 1.7
 *     - 2012-07-12 : v1.1. Taken into account the FamilySpecialAnnualContribution field and FamilyNbMembers can be = 0
 *     - 2013-09-18 : v1.2. Patch for the case $FamilyLastname = NULL, we must get the FamilyLastname value,
 *                    taken into account the FamilyMonthlyContributionMode field and the HistoFamilies table
 *     - 2017-09-21 : v1.3. Taken into account FamilyMainEmailContactAllowed and FamilySecondEmailContactAllowed fields
 *     - 2019-01-21 : v1.4. Taken into account FamilyMainEmailInCommittee and FamilySecondEmailInCommittee fields
 *     - 2019-07-16 : v1.5. Taken into acount the FamilyAnnualContributionBalance field
 *     - 2021-05-18 : v1.6. Taken into account FamilyMainPicture and FamilySecondPicture fields
 *     - 2022-06-06 : v1.7. Taken into account FamilyMonthlyNurseryMode field
 *
 * @since 2012-01-23
 *
 * @param $DbConnection                       DB object    Object of the opened database connection
 ...
 * @return Integer                            The primary key of the family [1..n], 0 otherwise
 */
 function dbUpdateFamily($DbConnection, $FamilyID, $FamilyDate, $FamilyLastname, $TownID, $FamilyMainEmail, $FamilySecondEmail = NULL, $FamilyNbMembers = NULL, $FamilyNbPoweredMembers = NULL, $FamilyBalance = NULL, $FamilyComment = NULL, $FamilyDesactivationDate = NULL, $FamilySpecialAnnualContribution = NULL, $FamilyMonthlyContributionMode = NULL, $FamilyMonthlyNurseryMode = NULL, $FamilyMainEmailContactAllowed = NULL, $FamilySecondEmailContactAllowed = NULL, $FamilyMainEmailInCommittee = NULL, $FamilySecondEmailInCommittee = NULL, $FamilyAnnualContributionBalance = NULL, $FamilyMainPicture = NULL, $FamilySecondPicture = NULL)
 {
     ...
     if (!is_Null($FamilyMainPicture))
     {
         // The FamilyMainPicture field will be updated
         $ArrayParamsUpdate[] = "FamilyMainPicture = \"$FamilyMainPicture\"";
     }
     ...
     if (!is_Null($FamilySecondPicture))
     {
         // The FamilySecondPicture field will be updated
         $ArrayParamsUpdate[] = "FamilySecondPicture = \"$FamilySecondPicture\"";
     }
     ...
     if (!is_Null($FamilyMonthlyNurseryMode))
     {
         if (($FamilyMonthlyNurseryMode < 0) || (!isInteger($FamilyMonthlyNurseryMode)))
         {
             // ERROR
             return 0;
         }
         ...
         {
             // The FamilyMonthlyNurseryMode field will be updated
             $ArrayParamsUpdate[] = "FamilyMonthlyNurseryMode = $FamilyMonthlyNurseryMode";
         }
     }
 ...
 function updateFamilyBalance($DbConnection, $FamilyID, $Value)
 {
     ...
     if (!DB::isError($DbResult))
     {
         if ($DbResult->numRows() > 0)
         {
             ...
             {
                 // Create an entry in the history of the family
                 $idHisto = dbAddHistoFamily($DbConnection, date("Y-m-d H:i:s"), $FamilyID, NULL, $fNewBalance, NULL, NULL);
 ...
 * @author Christophe Javouhey
 * @version 1.1
 *     - 2022-06-06 : v1.1. Taken into account HistoFamilyMonthlyNurseryMode field
 *
 * @since 2013-10-10
 *
 * @param $DbConnection                          DB object    Object of the opened database connection
 ...
 *                                                            1 => benefactor mode of monthy contribution
 *                                                            2 => ... [0..n]
 * @param $HistoFamilyMonthlyNurseryMode         Integer      0 => default mode to pay nursery registrations
 *                                                            1 => other mode to pay
 *                                                            2 => ... [0..n]
 *
 * @return Integer                               The primary key of the family history entry [1..n], 0 otherwise
 */
 function dbAddHistoFamily($DbConnection, $HistoDate, $FamilyID, $TownID, $HistoFamilyBalance = 0.00, $HistoFamilyMonthlyContributionMode = 0, $HistoFamilyMonthlyNurseryMode = 0)
 {
     if ($FamilyID > 0)
     {
         if ((is_null($TownID)) || (is_null($HistoFamilyBalance)) || (is_null($HistoFamilyMonthlyContributionMode))
             || (is_null($HistoFamilyMonthlyNurseryMode)))
         {
             ...
             if (!empty($RecordFamily))
             {
                 ...
                 $HistoFamilyMonthlyNurseryMode = $RecordFamily['FamilyMonthlyNurseryMode'];
             }
         }
     }
     else
     ...
     if (($TownID > 0) && ($HistoFamilyMonthlyContributionMode >= 0) && ($HistoFamilyMonthlyNurseryMode >= 0))
     {
         ...
         $DbResult = $DbConnection->query("SELECT h.HistoFamilyID FROM HistoFamilies h, (SELECT MAX(th.HistoFamilyID) AS MaxID
                                           ...
                                           AND h.HistoFamilyMonthlyNurseryMode = $HistoFamilyMonthlyNurseryMode
             ...
             if ($DbResult->numRows() == 0)
             {
                 ...
                 if ($id != 0)
                 {
                     $DbResult = $DbConnection->query("INSERT INTO HistoFamilies SET HistoFamilyID = $id, FamilyID = $FamilyID,
                                                       ...
                                                       HistoFamilyMonthlyNurseryMode = $HistoFamilyMonthlyNurseryMode $HistoDate");
                     if (!DB::isError($DbResult))
                     {
                         return $id;
                     }
 ...
 function getHistoFamilyForDate($DbConnection, $FamilyID, $HistoDate)
 {
     if ($FamilyID > 0)
     {
         ...
         $DbResult = $DbConnection->query("SELECT HistoFamilyID, HistoDate, FamilyID, TownID, HistoFamilyBalance,
                                          HistoFamilyMonthlyContributionMode, HistoFamilyMonthlyNurseryMode
                                          FROM HistoFamilies WHERE FamilyID = $FamilyID
                 ...
                 if ($DbResult->numRows() == 0)
                 {
                     ...
                     if (!empty($RecordFamily))
                     {
                         return array(
                                      ...
                                      'HistoFamilyBalance' => $RecordFamily['FamilyBalance'],
                                      'HistoFamilyMonthlyContributionMode' => $RecordFamily['FamilyMonthlyContributionMode'],
                                      'HistoFamilyMonthlyNurseryMode' => $RecordFamily['HistoFamilyMonthlyNurseryMode']
                                     );
                     }
                 }
                 else
 ...
 * @author Christophe Javouhey
 * @version 1.9
 *     - 2012-07-12 : v1.1. Taken into account the FamilySpecialAnnualContribution field to compute
 ...
 *     - 2013-03-11 : v1.2. Patch a bug about activated families (taken into account families arrived at school after
 *                    the beginning of the school year)
 *     - 2013-04-12 : v1.3. Allow to search several FamilyID (array) and taken into account the "FamilyCoopContribution" and
 *                    "FamilyPbCoopContribution" criterion
 *     - 2013-09-17 : v1.4. Use getSchoolYearStartDate() and getSchoolYearEndDate() to compute strat date and end date of
 *                    the school year and taken into account FamilyMonthlyContributionMode field
 *     - 2016-08-30 : v1.5. aken into account the FamilyDate and FamilyDesactivationDate fields
 *     - 2017-09-21 : v1.6. Taken into account FamilyMainEmailContactAllowed and FamilySecondEmailContactAllowed fields,
 *                    taken into account of the FamilyWorkGroups option
 *     - 2019-01-21 : v1.7. Taken into account FamilyMainEmailInCommittee and FamilySecondEmailInCommittee fields
 *     - 2019-07-16 : v1.8. Taken into account the FamilyAnnualContributionBalance field
 *     - 2022-06-06 : v1.9. Taken into account FamilyMonthlyNurseryMode field
 *
 * @since 2012-01-20
 *
 * @param $DbConnection             DB object              Object of the opened database connection
 ...
 */
 function dbSearchFamily($DbConnection, $ArrayParams, $OrderBy = "", $Page = 1, $RecordsPerPage = 10)
 {
     ...
     $Select = "SELECT f.FamilyID, f.FamilyLastname, f.FamilyMainEmail, f.FamilySecondEmail, f.FamilyBalance, f.FamilyAnnualContributionBalance, f.FamilyNbMembers,
               f.FamilyNbPoweredMembers, f.FamilyMonthlyContributionMode, f.FamilyMonthlyNurseryMode, f.FamilyMainEmailContactAllowed,
               f.FamilySecondEmailContactAllowed, f.FamilyMainEmailInCommittee, f.FamilySecondEmailInCommittee, t.TownID, t.TownName, t.TownCode";
     ...
     if (count($ArrayParams) >= 0)
     {
         ...
         if ((array_key_exists("FamilyMonthlyNurseryMode", $ArrayParams)) && (count($ArrayParams["FamilyMonthlyNurseryMode"]) > 0))
         {
             if ((array_key_exists("SchoolYear", $ArrayParams)) && (count($ArrayParams["SchoolYear"]) > 0))
             {
                 // We search families with given monthly nursery modes for a given school year (so, now)
                 $From .= ", HistoFamilies hf, (SELECT MAX(hfTmp.HistoFamilyID) AS MaxHistoFamilyID FROM HistoFamilies hfTmp
                           WHERE hfTmp.HistoDate <= \"$SchoolYearEndDate\" GROUP BY hfTmp.FamilyID) AS TmpHistoFamilies";

                 $Where .= " AND hf.HistoFamilyID = TmpHistoFamilies.MaxHistoFamilyID AND f.FamilyID = hf.FamilyID
                           AND hf.HistoFamilyMonthlyNurseryMode IN ".constructSQLINString($ArrayParams["FamilyMonthlyNurseryMode"]);
             }
             else
             {
                 // We search families with given monthly nursery modes for the current school year (so, now)
                 $Where .= " AND f.FamilyMonthlyNurseryMode IN ".constructSQLINString($ArrayParams["FamilyMonthlyNurseryMode"]);
             }
         }
     ...
     if (!DB::isError($DbResult))
     {
         if ($DbResult->numRows() != 0)
         {
             ...
             $ArrayRecords = array(
                                   ...
                                   "FamilyMonthlyNurseryMode" => array(),
                                   "TownID" => array(),
                                   "TownName" => array(),
                                   "TownCode" => array(),
                                   "NbChildren" => array()
             ...
             while($Record = $DbResult->fetchRow(DB_FETCHMODE_ASSOC))
             {
                 ...
                 $ArrayRecords["FamilyMonthlyNurseryMode"][] = $Record["FamilyMonthlyNurseryMode"];
 ...
 *     - 2013-09-17 : v1.4. Use getSchoolYearStartDate() and getSchoolYearEndDate() to compute strat date and end date of
 *                    the school year and taken into account FamilyMonthlyContributionMode field
 *     - 2016-08-30 : v1.5. Taken into account the FamilyDate and FamilyDesactivationDate fields
 *     - 2017-09-21 : v1.6. Taken into account FamilyMainEmailContactAllowed and FamilySecondEmailContactAllowed fields,
 *                    taken into account of the FamilyWorkGroups option
 *     - 2019-01-21 : v1.7. Taken into account FamilyMainEmailInCommittee and FamilySecondEmailInCommittee fields
 *     - 2022-06-06 : v1.8. Taken into account FamilyMonthlyNurseryMode field
 *
 * @since 2006-01-19
 *
 * @param $DbConnection         DB object              Object of the opened database connection
 ...
 */
 function dbFamiliesGDPRTreatment($DbConnection, $AnonymizedSupportMemberID, $ArrayParams = array())
 {
     if ($AnonymizedSupportMemberID > 0)
     {
         $ArrayConcernedID = array();
         $bFamiliesAnonymized = FALSE;
         $bSupportMemberDeleted = FALSE;
         $bLogsDeleted = FALSE;

         // First, we get concerned children
         $sDateCondition = " AND f.FamilyDesactivationDate IS NOT NULL AND f.FamilyDesactivationDate < "
                           .date('Y-m-d', strtotime("5 years ago"));
         ...
         if ((array_key_exists("FamilyDesactivationDate", $ArrayParams)) && (count($ArrayParams["FamilyDesactivationDate"]) == 2))
         {
             ...
             $sLogDateCondition = " AND LogEventDate ".$ArrayParams["FamilyDesactivationDate"][0]
                                  ." \"".$ArrayParams["FamilyDesactivationDate"][1]."\"";
         }

         // f.FamilyLastname REGEXP 'F[0-9]+' : to exclude already anonymized families
         $DbResult = $DbConnection->query("SELECT f.FamilyID, f.FamilyMainPicture, f.FamilySecondPicture
                                           FROM Families f
                                           WHERE f.FamilyMainEmailContactAllowed = 0 AND f.FamilySecondEmailContactAllowed = 0
                                           AND f.FamilyLastname REGEXP 'F[0-9]+' = 0 $sDateCondition
                                           ORDER BY f.FamilyID");
         ...
         if (!DB::isError($DbResult))
         {
             if ($DbResult->numRows() >= 0)
             {
                 while($Record = $DbResult->fetchRow(DB_FETCHMODE_ASSOC))
                 {
                     $ArrayConcernedID[] = $Record['FamilyID'];

                     // Delete pictures
                     if ((!empty($Record['FamilyMainPicture']))
                         && (file_exists($GLOBALS['CONF_UPLOAD_FAMILY_PICTURE_FILES_DIRECTORY_HDD'].$Record['FamilyMainPicture'])))
                     {
                         @unlink($GLOBALS['CONF_UPLOAD_FAMILY_PICTURE_FILES_DIRECTORY_HDD'].$Record['FamilyMainPicture']);
                     }

                     if ((!empty($Record['FamilySecondPicture']))
                         && (file_exists($GLOBALS['CONF_UPLOAD_FAMILY_PICTURE_FILES_DIRECTORY_HDD'].$Record['FamilySecondPicture'])))
                     {
                         @unlink($GLOBALS['CONF_UPLOAD_FAMILY_PICTURE_FILES_DIRECTORY_HDD'].$Record['FamilySecondPicture']);
                     }
                 }
             }
         }
         ...
         {
             $bFamiliesAnonymized = TRUE;
             $bSupportMemberDeleted = TRUE;
             $bLogsDeleted = TRUE;
         }
         else
         {
             // Anonymization of the family :
             // - anonymization of the lastname
             // - reset FamilyMainEmail and FamilySecondEmail
             // - reset FamilyMainEmailInCommittee and FamilySecondEmailInCommittee
             // - reset FamilyNbMembers and FamilyNbPoweredMembers
             // - reset FamilySpecialAnnualContribution
             // - set FamilyMonthlyContributionMode to default value
             // - set FamilyComment to empty value
             // - set FamilyBalance and FamilyAnnualContributionBalance to 0.00
             // - reset pictures
             $DbResult = $DbConnection->query("UPDATE Families SET FamilyLastname = CONCAT('F', FamilyID),
                                               FamilyMainEmail = '', FamilyMainEmailInCommittee = 0,
                                               FamilySecondEmail = '', FamilySecondEmailInCommittee = 0,
                                               FamilyNbMembers = 0, FamilyNbPoweredMembers = 0,
                                               FamilySpecialAnnualContribution = 0, FamilyComment = '',
                                               FamilyMonthlyContributionMode = ".MC_DEFAULT_MODE.",
                                               FamilyBalance = 0, FamilyAnnualContributionBalance = 0,
                                               FamilyMainPicture = NULL, FamilySecondPicture = NULL
                                               WHERE FamilyID IN ".constructSQLINString($ArrayConcernedID));
             if (!DB::isError($DbResult))
             {
                 // Families anonymized
                 $bFamiliesAnonymized = TRUE;
             ...
             // Next, we delete desactivated suport members linked to these families
             $DbResult = $DbConnection->query("DELETE FROM SupportMembers WHERE SupportMemberActivated = 0
                                               AND FamilyID IN ".constructSQLINString($ArrayConcernedID));
             if (!DB::isError($DbResult))
             {
                 // Desactivated support members deleted
                 $bSupportMemberDeleted = TRUE;
             }

             // Then, we delete event logs
             $DbResult = $DbConnection->query("DELETE FROM LogEvents WHERE LogEventItemType = \"".EVT_FAMILY."\"
                                               AND LogEventService = \"".EVT_SERV_FAMILY."\"
                                               AND LogEventItemID IN ".constructSQLINString($ArrayConcernedID));
             if (!DB::isError($DbResult))
             {
                 // Event logs about families deleted
                 $bLogsDeleted = TRUE;
             }
         }

         return (($bFamiliesAnonymized) && ($bSupportMemberDeleted) && ($bLogsDeleted));
     }
...
/**
 * Treat history entries of families data for GDPR
 *
 * @author Christophe Javouhey
 * @version 1.0
 * @since 2021-05-10
 ...
 * @return Boolean                      TRUE if GDPR treatment is done, FALSE otherwise
 */
 function dbHistoFamiliesGDPRTreatment($DbConnection, $AnonymizedSupportMemberID, $ArrayParams = array())
 {
     if ($AnonymizedSupportMemberID > 0)
     {
         $ArrayConcernedID = array();
         $bHistoryDeleted = FALSE;

         // First, we get concerned history entries of families
         $sDateCondition = " AND f.FamilyDesactivationDate IS NOT NULL AND f.FamilyDesactivationDate < "
                           .date('Y-m-d', strtotime("5 years ago"));
         if ((array_key_exists("FamilyDesactivationDate", $ArrayParams)) && (count($ArrayParams["FamilyDesactivationDate"]) == 2))
         {
         ...
         $DbResult = $DbConnection->query("SELECT hf.HistoFamilyID
                                           FROM HistoFamilies hf, Families f
                                           WHERE hf.FamilyID = f.FamilyID $sDateCondition
                                           ORDER BY hf.HistoFamilyID");
         ...
         if (!DB::isError($DbResult))
         {
             if ($DbResult->numRows() >= 0)
             {
                 while($Record = $DbResult->fetchRow(DB_FETCHMODE_ASSOC))
                 {
                     $ArrayConcernedID[] = $Record['HistoFamilyID'];
                 }
             }
         }
         ...
         if (empty($ArrayConcernedID))
         {
             $bHistoryDeleted = TRUE;
         }
         else
         {
             // We delete selected histry entries
             $DbResult = $DbConnection->query("DELETE FROM HistoFamilies
                                               WHERE HistoFamilyID IN ".constructSQLINString($ArrayConcernedID));
             if (!DB::isError($DbResult))
             {
