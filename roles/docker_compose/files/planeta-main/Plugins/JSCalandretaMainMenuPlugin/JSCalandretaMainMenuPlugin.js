 ...
 *     - 2021-04-09 : taken into account the "Forum" module
 *
 * @since 2013-12-31
 */
 function initCalandretaMainMenuPlugin(Path)
 {
        ...
        var ArrayMainMenuUrl = new Array('Canteen', 'Cooperation', 'Forum');
        ...
        if (document.getElementById('header')) {
            ...
            AppTitle.className = 'MainMenuPlugin' + sSuffixStyle;
        }

        // Main menu bar
        if (document.getElementById('mainmenu')) {
            var MainMenuBar = document.getElementById('mainmenu');
            MainMenuBar.className = 'MainMenuPlugin' + sSuffixStyle;
            ...
            var ArrayMainMenuIcons = new Array('canteen.png', 'cooperation.png', 'forum.png');
            var ArrayMainMenuSelectedIcons = new Array('canteen_selected.png', 'cooperation_selected.png', 'forum_selected.png');
 ...
 {
        if (MainMenuPluginIsAdmin) {
            var ArrayMainMenuSelectedIcons = new Array('canteen_selected.png', 'cooperation_selected.png', 'forum_selected.png', 'admin_selected.png', 'logout_selected.png');
        }  else {
            var ArrayMainMenuSelectedIcons = new Array('canteen_selected.png', 'cooperation_selected.png', 'forum_selected.png', 'logout_selected.png');
        }
 ...
 {
        if (MainMenuPluginIsAdmin) {
            var ArrayMainMenuIcons = new Array('canteen.png', 'cooperation.png', 'forum.png', 'admin.png', 'logout.png');
        } else {
            var ArrayMainMenuIcons = new Array('canteen.png', 'cooperation.png', 'forum.png', 'logout.png');
        }
